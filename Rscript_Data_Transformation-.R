...
# Loading dataset, which you can find on my Github as well.
...
load("~/sdata_final.RData") # loading new dataset to environment.
...
# Changing the order so that Trade and Business is reference-category in the numeric category variable:
